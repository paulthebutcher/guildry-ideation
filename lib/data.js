    ...
    entities: [
      {
        id: "organization",
        name: "Organization",
        desc: "The user's company — an agency, consultancy, or studio. Top-level tenant.",
        fields: [
          { name: "id", type: "uuid", key: "pk" },
          { name: "name", type: "string" },
          { name: "slug", type: "string" },
          { name: "type", type: "enum", values: "agency | consultancy | studio" },
...
export const PRODUCT_DETAILS = {
  scout: {
    problem: "Before you can make a decision, you need to notice something worth deciding about. BD and strategy teams waste hours scanning competitors, reading funding announcements, and trying to spot positioning shifts.",
  ...
  blueprint: {
    problem: "Services firms consistently underestimate projects, lose money on fixed-bid work, and spend hours building proposals manually. Scoping is art when it should be data-informed craft.",
...
export const ROADMAP_PHASES = [
  ...
  },
  {
    ...
    milestone: "Closed feedback loop: scope → staff → deliver → learn → improve estimates. Learning loop starts turning.",
  },
  {
    phase: "Phase 2",
