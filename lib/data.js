export const PRODUCTS = {
  signal: { name: "Signal", color: "#b45309", phase: "Notice", tagline: "Competitive & market intelligence monitor", icon: "◉" },
  plinth: { name: "Plinth", color: "#4f46e5", phase: "Decide", tagline: "AI-powered strategic decision tool", icon: "◆" },
  armature: { name: "Armature", color: "#0d9488", phase: "Scope", tagline: "Project estimation & scoping engine", icon: "▲" },
  ...
  folio: { name: "Folio", color: "#059669", phase: "Sell", tagline: "Dynamic case study & proof generator", icon: "◻" },
};

export const PRODUCT_KEYS = Object.keys(PRODUCTS);

export const PIPELINE_PHASES = [
  { key: "signal", label: "Notice" },
  { key: "plinth", label: "Decide" },
  { key: "armature", label: "Scope" },
  { key: "bench", label: "Staff" },
  { key: "relay", label: "Manage" },
  { key: "retro", label: "Learn" },
  { key: "folio", label: "Sell" },
];
    ...
    entities: [
      {
        ...
        usedBy: ["signal", "plinth", "armature", "bench", "relay", "retro", "folio"],
      },
      {
        id: "user",
        name: "User",
      ...
      },
      {
        ...
        usedBy: ["armature", "relay", "retro", "folio", "signal"],
      },
    ],
  },
  {
    ...
    entities: [
      {
        ...
        fields: [
          ...
          { name: "decision_id", type: "uuid", key: "fk", ref: "decision", note: "nullable — Plinth link" },
          { name: "name", type: "string" },
        ...
        usedBy: ["armature", "bench", "relay", "retro", "folio", "plinth"],
      },
      {
        id: "phase",
        name: "Phase",
  ...
  },
  {
    ...
    entities: [
      ...
      },
      {
        ...
        usedBy: ["armature", "plinth", "folio"],
      },
      {
        id: "decision",
        name: "Decision",
        desc: "A strategic decision modeled in Plinth.",
        fields: [
          { name: "id", type: "uuid", key: "pk" },
          { name: "org_id", type: "uuid", key: "fk", ref: "organization" },
    ...
    entities: [
      {
        ...
        usedBy: ["armature", "relay", "folio", "retro", "plinth"],
      },
      {
    ...
    entities: [
      {
        ...
        fields: [
          ...
          { name: "product", type: "enum", values: "signal | plinth | armature | bench | relay | retro | folio" },
...
export const PRODUCT_DETAILS = {
  signal: {
    ...
    bridgeTo: "Signal detects an opportunity → triggers a Plinth decision → which spawns an Armature scope.",
  },
  plinth: {
    ...
    bridgeTo: "A decided option can spawn an Armature project scope with one click.",
  },
  armature: {
    ...
    bridgeTo: "Completed scopes feed into Bench for staffing, Relay for project management, and eventually Retro for learning.",
  },
  bench: {
    ...
    solution: "Lightweight talent CRM mapping your network with skills, rates, availability, and performance history. When Armature generates a team plan, Bench matches real people to abstract roles and flags gaps.",
    ...
    bridgeTo: "Bench assigns real people to Armature's role requirements. Performance data from Retro improves future matching.",
  },
  relay: {
    ...
    bridgeTo: "Relay reads Armature's SOW to detect drift. Communication data feeds Retro's retrospectives.",
  },
  retro: {
    ...
    bridgeTo: "Retro data feeds into Armature's estimation models and Bench's performance ratings. This is the learning layer.",
  },
  folio: {
    ...
    bridgeTo: "Folio pulls from Retro's data and Armature's scope history. When Relay detects a sales conversation, Folio drafts supporting materials.",
  },
};
...
export const ARCHITECTURE_PRINCIPLES = [
  {
    ...
    desc: "Each entity is written by one product but can be read by many. Project is owned by Armature but read by Relay, Retro, and Folio. This prevents write conflicts and makes the ownership model clear.",
    icon: "✦",
  },
  {
    title: "Nullable foreign keys as bridges",
    desc: "Cross-product references are always nullable. A Project can exist without a Decision (no Plinth). A Document can exist without a Project. Each product works standalone.",
    icon: "◇",
  },
  {
  ...
  },
  {
    ...
    desc: "PhasePerformance data from completed projects feeds into EstimationModel coefficients. Over time, Armature's estimates self-correct using real project data.",
    icon: "↻",
  },
  {
...
export const ROADMAP_PHASES = [
  ...
  },
  {
    ...
    color: "#0d9488",
    items: [
      "Conversational project scoping flow",
      "Website scraper + Lighthouse integration",
      "Fix vs. rebuild analysis",
      "Market rate engine (static dataset v1)",
      "Team builder with role/skill matching",
      "SOW + proposal document generation",
    ],
    milestone: "End-to-end: describe a project → get a scope, team plan, and SOW. Put in front of 10 freelancers.",
  },
  {
    phase: "Phase 2",
    name: "Bench + Retro",
    ...
    color: "#dc2626",
    items: [
      "Talent CRM (Person + Skill entities)",
      "Availability tracking",
      "Armature → Bench integration (match real people to roles)",
      "Retrospective conversational flow",
      "Phase performance tracking",
      "Estimation model v1 (variance-based adjustments)",
    ],
    milestone: "Closed loop: scope → staff → deliver → learn. Estimation accuracy improves with each project.",
  },
  {
    phase: "Phase 3",
    name: "Relay + Folio",
    ...
    items: [
      ...
      "Scope drift detection against SOW",
      "Change order generation",
      "Dynamic case study generator",
      "Prospect-tuned portfolio briefs",
  ...
  {
    phase: "Phase 4",
    name: "Signal + Plinth Integration",
    ...
    items: [
      ...
      "Signal → Decision → Project pipeline",
